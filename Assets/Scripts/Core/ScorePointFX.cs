...
public class ScorePointFX : Movable
{
    ...
    private readonly Color _orangeColor = new(1f, 0.4f, 0f);
    private readonly Color _blueColor = new(0.06f, 0.5f, 1f);
    ...
    public void PlayVFX(Vector3 pos, int score, MatchableColor color)
    {
        SetTextColor(color);
